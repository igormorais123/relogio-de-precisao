...
${stage(0,'Defina o que uma revisão pode mudar sem distorcer o registro.',check('preserve','Preservar a data do teste, as duas medianas e os grupos de 50 pedidos.')+check('limits','Separar resultado observado de causa demonstrada e de autorização de adoção definitiva.'),'Registrar critérios')}
