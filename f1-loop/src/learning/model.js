...
export function checkCorrection(choice, reason) {
  ...
  return { passed: true, message: 'Você preservou data, medianas e grupos, retirou a causa não isolada e a data sem confirmação e a afirmação de treinamento sem fonte.' };
}
